    ...
    <nav>
        <div class="container nav-container">
            ...
            <div class="create">
                ...
                <?php echo '<img src="data:'.$user['photo_type'].';base64,'.base64_encode($user['photo']).'" alt="Photo de profil">';
 ?>
                </div>
            </div>
        </div>
        ...
        <div class="container main-container">
            ...
            <div class="main-left">
              <div class="profile">
                ...
                <div class="hendel">
                    <h4><?php $user['pseudo'] ?></h4>
                    <p class="text-gry"><?php $user['id_two'] ?></p>
                </div>  
              </div>
              ...
              <div class="side-bar"> 
                ...
                <a class="menu-item g" >
                    <span><img src="icon/gear.svg" class="icon1"></span><h3>setings</h3>
                </a>   
